...
cd $ANDROID_SDK_ROOT
curl https://dl.google.com/android/repository/platform-tools-latest-darwin.zip -o sdk-tools.zip
...
echo "y" | sudo $SDKMANAGER --install "ndk;21.4.7075529" --sdk_root=${ANDROID_SDK_ROOT}