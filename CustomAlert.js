...
import { Alert, Modal, StyleSheet, Text, Pressable, View, Platform,TouchableOpacity } from "react-native";
...
export const CustomAlert = (props) => {
  ...
  const [androidDefaults, setAndroidDefaults] = useState({
    ...
    title: {
      ...
      fontFamily: (props.android && props.android.title && props.android.title.fontFamily),
    ...
    message: {
      ...
      fontFamily: (props.android && props.android.message && props.android.message.fontFamily),
  ...
  const [iOSDefaults, setIOSDefaults] = useState({
    ...
    title: {
      ...
      fontFamily: (props.ios && props.ios.title && props.ios.title.fontFamily),
    ...
    message: {
      ...
      fontFamily: (props.ios && props.ios.message && props.ios.message.fontFamily),
  ...
  const IOSButtonBox = () => {
    ...
    return (
      <TouchableOpacity style={[styles.iOSButtonGroup, {
        flexDirection: buttonLayoutHorizontal === 1 ? "row" : "column",
      }]} onLayout={(e) => {
        if(e.nativeEvent.layout.height > 60)
          setButtonLayoutHorizontal(0);
  ...
  return (
    <Modal
      ...
      >
        <Pressable style={[Platform.OS === "ios" ? styles.iOSBackdrop : styles.androidBackdrop, styles.backdrop]} onPress={() => console.log("dsfds")} />
